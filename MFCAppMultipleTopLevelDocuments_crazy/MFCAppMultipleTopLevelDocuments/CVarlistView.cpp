...
{
	HTREEITEM hRoot = m_wndVarlistView.InsertItem(_T("FakeApp files"), 0, 0);
	m_wndVarlistView.SetItemState(hRoot, TVIS_BOLD, TVIS_BOLD);

	HTREEITEM hSrc = m_wndVarlistView.InsertItem(_T("FakeApp Source Files"), 0, 0, hRoot);

	m_wndVarlistView.InsertItem(_T("FakeApp.cpp"), 1, 1, hSrc);
	...
	HTREEITEM hInc = m_wndVarlistView.InsertItem(_T("FakeApp Header Files"), 0, 0, hRoot);

	m_wndVarlistView.InsertItem(_T("FakeApp.h"), 2, 2, hInc);
